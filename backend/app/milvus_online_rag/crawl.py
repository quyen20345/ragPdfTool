...
# https://api.python.langchain.com/en/latest/document_loaders/langchain_community.document_loaders.recursive_url_loader.RecursiveUrlLoader.html#:~:text=import%20BeautifulSoup%0A%0Adef-,bs4_extractor,-(html%3A
